...
def generate_label_json_PL(doc, items, service_type="Pneus Hub", label_type=None, custom_header=False, skip_custom_printers=False,submission_date=""):
    """
...
def download_label_json_PL(doc, items=None, service_type="Pneus Hub", label_type=None, custom_header=False, skip_custom_printers=False,submission_date=""):
    """
...
@frappe.whitelist()
def generate_json_labels_PL(doctype, docname, service_type="Pneus Hub", label_type=None, custom_header=False, skip_custom_printers=False,customer_has_own_printer=False,submission_date=""):
    """
