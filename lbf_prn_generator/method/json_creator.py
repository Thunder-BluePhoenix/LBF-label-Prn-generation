...
def generate_label_json(doc, items, service_type="Pneus Hub", label_type=None, custom_header=False, skip_custom_printers=False,customer_has_own_printer=False):
    """
...
def download_label_json(doc, items=None, service_type="Pneus Hub", label_type=None, custom_header=False, skip_custom_printers=False,customer_has_own_printer=False):
    """
...
@frappe.whitelist()
def generate_json_labels(doctype, docname, service_type="Pneus Hub", label_type=None, custom_header=False, skip_custom_printers=False,customer_has_own_printer=False):
    """
